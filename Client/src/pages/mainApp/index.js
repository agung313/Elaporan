...
import { Absensi, AbsensiKurang, Agenda, BgApp, CloseIcont, ExFoto, LgBappeda, NotifIcont, SettIcont, TidakHadir, offAgenda } from '../../assets/images';
...
const MainApp = ({ navigation}) => {
    ...
    // console.log(getStrMonth, "<----- hari")
    return (
        
        <ImageBackground source={BgApp} style={{width:WindowWidth, height:WindowHeight}}>
            <ScrollView>
                <View style={{ width:WindowWidth, height:200,}}>
                    <View style={{ width:WindowWidth, marginTop:15, alignItems:'center' }}>
                            
                        <View style={{flexDirection:'row'}}>
                            <TouchableOpacity><Image source={SettIcont} style={{width:30, height:30}}/></TouchableOpacity>
                           ...
                           <TouchableOpacity><Image source={NotifIcont} style={{width:28, height:28}}/></TouchableOpacity>
                        </View>
                    </View>
                ...
                <View style={{backgroundColor:"#f3f3f3", width:WindowWidth, height:WindowHeight, borderTopRightRadius:40, borderTopLeftRadius:40, alignItems:"center" }}>
                    ...
                    <View style={{width:WindowWidth*0.7, height:200, backgroundColor:"white", borderRadius:15, marginTop:20, elevation:10, alignItems:"center"}}>
                        ...
                        <View style={{flexDirection:'row', marginTop:15}}>
                            <TouchableOpacity style={{ width:100, height:100, alignItems:'center', justifyContent:'center', marginRight:15 }}>
                        ...
                        <TouchableOpacity style={{backgroundColor:"#39a339", width:200, height:30, borderRadius:15, marginTop:10, alignItems:"center", justifyContent:"center"}} onPress={toggleModal}>
                    ...
                    <View style={{width:WindowWidth*0.9, height:200, marginTop:40, alignItems:"center"}}>
                        ...
                        <TouchableOpacity style={{width:WindowWidth*0.85, height:40, backgroundColor:'#39a339', borderRadius:15, elevation:5, marginBottom:20, alignItems:"center", justifyContent:"center"}}>
                            <Text style={{fontWeight:'700', color:"white", textShadowColor:"#000", textShadowOffset: {width: -1, height: 1}, textShadowRadius: 5, fontSize:15}}>Riwayat Lainnya</Text>
                        </TouchableOpacity>
                    </View>
