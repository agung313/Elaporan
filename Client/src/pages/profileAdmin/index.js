import { Dimensions, ScrollView, StyleSheet, Text, View, ImageBackground, TouchableOpacity, Image, TextInput } from 'react-native'
...
const ProfileAdmin = ({navigation}) => {
    ...
    return (
      <ScrollView>
          <ImageBackground source={BgApp} style={{width:WindowWidth, height:265}}>
              ...
              <View style={{alignItems:"center", width:WindowWidth, height:200, }}>
                  <View style={{alignItems:"center", marginTop:20}}>
                      {imgFoto?<Image source={imgFileFoto} style={{width:100, height:100, borderRadius:50,}} resizeMode='cover'/>:<Image source={EmailIcon} style={{width:100, height:100, borderRadius:50,}} resizeMode='cover'/>}
                      ...
                      <View style={{ alignItems:"center", marginTop:15}}>
                          ...
                          <Text style={{ fontWeight:'700', color:"white", textShadowColor:"#000", textShadowOffset: {width: -1, height: 1}, textShadowRadius: 5, fontSize:13, marginTop:5}}>Jabatan : {jabatanUser}</Text>
                      </View>
                  </View>
              </View>
          </ImageBackground>
              ...
              <View style={{width:"90%", minHeight:100, alignItems:"center",}}>
                  ...
                  <View style={showContent===1 ? {display:"flex"} : {display:"none"}}>
                      ...
                      <View style={{width:WindowWidth*0.9, minHeight:WindowHeight*0.3, backgroundColor:"white", borderRadius:15, elevation:5, marginBottom:15, padding:10}}>
                          ...
                          <View style={{marginBottom:25, flexDirection:"row",marginTop:15, marginLeft:15}}>
                              ...
                              <View style={{marginLeft:8, justifyContent:"center"}}>
                                  ...
                                  <TextInput
                                      ...
                                      value={namaUser}
                                      onChangeText={(text) => setNamaUser(text)}
                          ...
                          <View style={{marginBottom:25, flexDirection:"row",marginTop:15, marginLeft:15}}>
                              ...
                              <View style={{marginLeft:8, justifyContent:"center"}}>
                                  ...
                                  <TextInput
                                      ...
                                      placeholderTextColor={"#000"}
                                      value={jabatanUser}
                                      onChangeText={(text) => setJabatanUser(text)}
                                      style={{ color: "#000", borderBottomColor: "#000",borderBottomWidth: 1, borderStyle:"dashed", marginLeft:-3, paddingBottom:0, width:238, marginTop:-15 }}
                                      textContentType={'name'}
                                      // multiline
                                  />
                          ...
                          <View style={{alignItems:"center", marginTop:15}}>
                              <TouchableOpacity style={{width:WindowWidth*0.6, minHeight:30, backgroundColor:"#39a339", borderRadius:15, elevation:5, marginBottom:15, padding:10, alignItems:"center", justifyContent:"center"}} onPress={() => setModalData(true)}>
                                  <Text style={{ fontWeight:'900', color:"white", textShadowColor:"#000", textShadowOffset: {width: -1, height: 1}, textShadowRadius: 5, fontSize:16}}>Update Data Pengguna</Text>
                              </TouchableOpacity>
                          </View>
                      </View>
                  </View>
          ...
          {/* modal side update data pengguna */}
          <ReactNativeModal isVisible={modalData} onBackdropPress={() => setModalData(false)}  style={{ alignItems: 'center',  }} animationOutTiming={1000} animationInTiming={500} animationIn="zoomIn">
              <View style={{ width: "90%", height: "25%", backgroundColor: "#fff", borderRadius: 10,  padding:10, justifyContent:"center" }}>

                  <TouchableOpacity  style={{alignItems:'flex-end'}} onPress={() => setModalData(false)}>
                      <Image source={CloseIcont} style={{width:30, height:30}}/>
                  </TouchableOpacity>
                  <View style={{width:"100%", marginTop:10, alignItems:"center"}}>
                      <Text style={{fontWeight:'700', color:"black", textShadowColor:"#000", fontSize:15, textTransform:"capitalize"}}>Apakah anda yakin merubah data ?</Text>
                  </View>
                  <View style={{width:"100%", alignItems:"center",  marginTop:25,}}>
                      <View style={{flexDirection:"row"}}>
                          <TouchableOpacity style={{width:120, height:40, backgroundColor:"#d9dcdf", borderRadius:10, justifyContent:"center", alignItems:"center", marginRight:15}} onPress={() => setModalData(false)}>
                              <Text style={{fontWeight:'700', color:"black", textShadowColor:"#fff", textShadowOffset: {width: -1, height: 1}, textShadowRadius: 5, fontSize:15}}>Tidak</Text>
                          </TouchableOpacity>

                          <TouchableOpacity style={{width:120, height:40, backgroundColor:"#39a339", borderRadius:10, justifyContent:"center", alignItems:"center"}} onPress={() => setModalData(false)}>
